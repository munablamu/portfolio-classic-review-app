<form action="{{ route('search.index') }}" method='get' class="flex flex-col sm:flex-row items-center m-2 flex-grow sm:w-auto">
  <select name="search_type" class="rounded-md sm:rounded-r-none h-10 pl-5 pr-10 w-full sm:w-auto border border-slate-300 text-slate-600 bg-slate-100 hover:border-slate-400 focus:outline-none appearance-none">
