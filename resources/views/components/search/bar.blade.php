<form action="{{ route('search.index') }}" method="get" class="mx-5">
  <div class="flex flex-col sm:flex-row items-center">
    <select name="search_type" class="w-full sm:w-auto rounded-md sm:rounded-r-none h-10 capitalize pl-4 pr-8 border-slate-300 text-slate-600 bg-slate-100 hover:border-slate-400 dark:border-slate-700 dark:text-slate-125 dark:bg-slate-800 dark:hover:border-slate-600 focus:outline-none appearance-none">
