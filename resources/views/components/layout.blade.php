...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="{{ $theme }}">
  ...
  <body class="flex flex-col min-h-screen font-sans bg-slate-125 text-slate-600 dark:bg-slate-700 dark:text-slate-250 md:antialiased">
    ...
    {{-- help --}}
    <div id="help-open" class="fixed bottom-28 sm:bottom-16 left-4 w-16 h-16 rounded-full bg-slate-600 text-slate-100 dark:bg-slate-100 dark:text-slate-700 flex items-center justify-center shadow-2xl text-3xl z-20 cursor-pointer hidden">
