<x-layout>
  <div class="mx-5 my-5">
    ...
    <h2 class="text-2xl mt-4 mb-2 font-bold text-slate-500 dark:text-slate-500">録音と演奏家の詳細ページ</h2>
    ...
    <h2 class="text-2xl mt-4 mb-3 font-bold text-slate-500 dark:text-slate-500">ルーティング</h2>
    <p>　お問い合わせフォームはフッターにあります。</p>

    <h2 class="text-2xl mt-4 mb-3 font-bold text-slate-500 dark:text-slate-500">データベース上の作曲家一覧</h2>
    <p>　お問い合わせフォームはフッターにあります。</p>
