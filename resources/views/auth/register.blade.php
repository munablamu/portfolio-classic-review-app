...
<x-common.help message="アカウント作成ページです。なお、ログインページからサンプルアカウント（メールアドレス：<strong class='strong-color-invert'>sample@example.com</strong>、パスワード：<strong class='strong-color-invert'>password</strong>）でもログイン可能です。" />
